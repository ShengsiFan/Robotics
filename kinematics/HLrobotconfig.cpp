...
int main()
{
	...
	double q1[6] = { 11.3807 * PI / 180, - 1.93098 * PI / 180,  89.5407 * PI / 180, - 1.3684 * PI / 180,  81.5509 * PI / 180,  55.4894 * PI / 180 };
	double q2[6] = { 7.97643 * PI / 180, -1.85575 * PI / 180, 89.4303 * PI / 180,  5.20289 * PI / 180,  84.1104 * PI / 180,  56.8627 * PI / 180 };
	//double q[6] = { 0,0,0,0,PI/4,0 };
	double Tool[16]{ 0 };
	HLRobot::robotForwardHJQ(q1, Tool, Tran1, config, Turns);
	double theta[6] = {0};
	...
	cout << endl;
	HLRobot::robotForwardHJQ(q2, Tool, Tran2, config, Turns);
	for (int i = 0; i < 16; i++)
	{
		cout << Tran2[i] << '\t';
		if (i % 4 == 3)
	...
	HLRobot::robotBackwardHJQ(Tran1, config, Tool, Turns, theta);
	for (int i = 0; i < 6; i++)
	{
	...
	HLRobot::robotBackwardHJQ(Tran2, config, Tool, Turns, theta);
	for (int i = 0; i < 6; i++)
	{
		cout << theta[i] * 180 / PI << endl;
	}
